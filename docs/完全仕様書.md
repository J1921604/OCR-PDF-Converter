...
**バージョン**: 1.0.0  
**最終更新**: 2026-1-15  
**プロジェクト**: [OCR-PDF-Converter](https://github.com/J1921604/OCR-PDF-Converter)  
...
6. [テスト戦略](#テスト戦略)
7. [デプロイメント](#デプロイメント)
8. [パフォーマンスとスケーラビリティ](#パフォーマンスとスケーラビリティ)
...
| OCRエンジン | Tesseract.js | 5.1.0 |
| PDF生成 | pdf-lib | 1.17.1 |
...
flowchart LR
    ...
    B -->|PDF.js| C[PDFDocument]
    C -->|getPage| D[PDFPage]
    D -->|render| E[Canvas]
    E -->|Tesseract.js| F[OCRResult]
    F -->|coordinateConverter| G[TextLayerItem[]]
    G -->|pdf-lib| H[SearchablePDF]
    H -->|Blob| I[Download]
